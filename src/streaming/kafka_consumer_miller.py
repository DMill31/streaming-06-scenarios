...
from streaming.visualizations.live_visualizations_miller import (
    close_live_chart,
    init_live_chart,
    save_live_chart,
    update_live_chart,
...
def initialize_output() -> tuple[Any, Any, dict[str, float], RunningStats]:
    ...
    Returns:
        A tuple of (figure, axis, sales_by_payment, stats).
    """
    ...
    figure, axis, sales_by_payment = init_live_chart()
    LOG.info("Live chart initialized.")

    stats = RunningStats()
    return figure, axis, sales_by_payment, stats
...
def main() -> None:
    ...
    figure, axis, sales_by_payment, stats = initialize_output()
