"""src/streaming/data_engineering/derived_fields_miller.py.
...
We add total_price, tax_amount, total, and payment_channel as derived fields.
...
def enrich_message(
    ...
    # Adding payment channel for business meaning to compliment chart
    payment_channel = (
        "wallet"
        if payment_method in ["paypal", "apple_pay"]
        else "direct"
